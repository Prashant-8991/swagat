...
const SearchQueryPage = () => {
    ...
    return (
        <div className="p-6 h-full flex flex-col relative">
            ...
            <div className="ag-theme-quartz h-[600px] w-full shadow-lg rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 mb-8">
                <AgGridReact
                    columnDefs={colDefs}
            ...
            <Modal
                ...
                ariaHideApp={false} 
            >
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden transform transition-all border border-gray-100 dark:border-gray-700 animate-in fade-in zoom-in duration-200">
                    ...
                    <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                        <button
                            onClick={closeModal}
                            className="px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:ring-2 focus:ring-gray-200"
                        >
                            Close
                        </button>
                        <button
                            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors shadow-md hover:shadow-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
