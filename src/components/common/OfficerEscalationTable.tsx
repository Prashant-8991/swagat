            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="block pl-3 pr-10 py-1 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    >
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {ranks.map((officer) => (
                                <tr key={officer.rank} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-right font-semibold text-indigo-600 dark:text-indigo-400">
