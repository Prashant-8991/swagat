...
export default function EscalatedCitizenComponent() {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="text-center max-w-md p-8 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:shadow-lg transition-all"
          >
            Reload Page
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
      <ContextMenu
      ...
      <div className="max-w-[1800px] mx-auto space-y-6">
            ...
            {['GS', 'TS', 'DS', 'LF', 'RLF', 'WTC'].map((type) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${
                  (mergedFilters.programTypes || []).includes(type)
        ...
        {hasActiveFilters && (
          <>
            <div id="active-filters-pane" className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-4 border border-black dark:border-slate-700/50 shadow-lg">
              <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="group relative bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-6 hover:scale-102 transition-transform duration-300 dark:border-slate-700/50 shadow-lg hover:shadow-xl">
          ...
          <div className="group relative bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-6 hover:scale-102 transition-transform duration-300 dark:border-slate-700/50 shadow-lg hover:shadow-xl">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <h3 className="text-4xl font-bold dark:from-indigo-400 dark:to-indigo-600 bg-clip-text text-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-6 hover:scale-101 transition-transform duration-300 dark:border-slate-700/50 shadow-lg">
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full px-4 py-2.5 bg-white dark:bg-gray-700 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-slate-500 focus:border-transparent text-slate-900 dark:text-slate-100 placeholder-slate-500"
              />
            </div>
...
function FilterBadge({ label, value, onClear, color }: any) {
  const colorClasses = {
    indigo: 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-700/50',
    ...
    purple: 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-700/50',
...
function KPICardWithTrend({ title, trendValue, trendDirection, gradient }: any) {
  ...
  return (
    <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-6 hover:scale-105 transition-transform duration-300 dark:border-slate-700/50 shadow-lg hover:shadow-xl ">
      <div className="flex items-center justify-between mb-4">
        <div className="flex-1">
...
function ChartCard({ title, children, onDownload }: any) {
  return (
    <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl p-6 hover:scale-102 transition-transform duration-300 dark:border-slate-700/50 shadow-lg hover:shadow-xl ">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 flex items-center gap-2">
          {title}
        </h3>
...
function StickyMiniActiveFilters({ filters, globalFilters, clearFilters, updateFilter, dispatch }: any) {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-auto max-w-[700px] w-full bg-white/95 dark:bg-gray-900/95 border border-black dark:border-gray-700 rounded-lg px-4 py-2 flex items-center gap-2 shadow-lg"
      >
