...
//   <div className={`relative bg-white p-1 rounded-2xl shadow-xl hover:scale-101 transition-transform duration-300 flex flex-col overflow-hidden group ${className}`}>
...
//   return (
//     <div className="max-h-[90vh] bg-yellow-600 scroll-auto flex flex-col gap-2  from-gray-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 p-6">
//       <div >
//         <ContextMenu
...
//             className="group flex items-center gap-2 px-4 py-2 rounded-xl bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 text-sm font-medium transition-all border border-red-200 dark:border-red-800 shadow-sm hover:shadow-md active:scale-95"
//           >
//             <span>✕</span>
...
//                 'DS': 'from-purple-600 to-purple-700',
...
//                     ? `bg-gradient-to-r ${colorMap[type]} text-white shadow-lg scale-105`
//                     : 'bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:bg-white/80 dark:hover:bg-gray-800/80 border border-gray-300 dark:border-gray-700 hover:scale-105'
//                     }`}
//                 >
//                   {type}
//                 </button>
...
//                        shadow-orange-500/50 hover:shadow-orange-500/80 hover:scale-[1.005] 
...
export default function SubjectCategory() {
  ...
  return (
    <div className="max-h-[95vh] scroll-auto flex flex-col gap-2  from-gray-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 p-6">
      <div >
        <ContextMenu
          visible={contextMenu.visible}
          x={contextMenu.x}
