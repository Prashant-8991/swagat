...
export default function StickyMiniActiveFilters({
  ...
  return (
    ...
    >
      <div className="pointer-events-auto max-w-[600px] w-full bg-white/95 dark:bg-gray-900/95 border border-black dark:border-gray-700 rounded-lg px-4 py-2 flex items-center gap-2 shadow-lg">
        ...
        <div className="flex flex-wrap gap-1">
          ...
          {filters.programTypes && filters.programTypes.length > 0 && (
            filters.programTypes.map((type) => (
              <span key={type} className="px-3 py-1.5 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-lg text-xs flex items-center gap-2 border border-indigo-200 dark:border-indigo-800">
          ...
          {filters.aiCategory && (
            <span className="px-3 py-1.5 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-lg text-xs flex items-center gap-2 border border-indigo-200 dark:border-indigo-800">
        ...
        <button
          ...
          className="ml-auto px-2 py-1 rounded bg-red-50 hover:bg-red-100 dark:bg-red-900/30 dark:hover:bg-red-900/50 text-red-600 dark:text-red-400 text-xs font-medium border border-red-200 dark:border-red-800 shadow-sm hover:shadow transition-all"
