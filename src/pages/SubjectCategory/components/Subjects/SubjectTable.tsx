...
export default function SubjectTable({
 ...
 <div
 id="subject-table"
 className="relative bg-white p-1 rounded-2xl shadow-sm transition-transform duration-300 flex flex-col overflow-hidden group"
 >
 ...
 className="bg-white/80 backdrop-blur-sm dark:bg-gray-700/40 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2"
 >
