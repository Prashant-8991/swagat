...
export default function SubjectSummaryCard({
  ...
  return (
    <div className="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-black/50 dark:border-gray-700/50 rounded-2xl p-6 shadow-lg flex flex-col">
      ...
      {subjects.length > 0 ? (
        <>
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="p-4 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl border border-black dark:border-purple-700">
              <div className="text-2xl font-bold text-black dark:text-purple-300">
            ...
            <div className="p-4 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border border-black dark:border-blue-700">
                ...
                <div
                  ...
                  className={`p-3 rounded-lg cursor-pointer transition-all ${
                    selectedSubject === subject.subjectCategory
                      ...
                      : 'bg-gray-50 dark:bg-gray-800/50 border border-black dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold text-black dark:text-purple-300">
          ...
          <div className="mt-auto pt-4 border-t border-black dark:border-gray-700">
            <a
              href="#subject-table"
