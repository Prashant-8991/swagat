...
const DepartmentTalukaChart: React.FC<DepartmentTalukaChartProps> = ({
 ...
 className="appearance-none px-4 py-2 pr-8 text-sm font-medium bg-white/80 backdrop-blur-sm dark:bg-gray-800/40 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-teal-500"
 >
 ...
 className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-teal-600 hover:text-teal-800 hover:bg-teal-50 rounded-lg transition-all"
 >
 <HiArrowLeft className="w-4 h-4" />
 Back
 </button>
 <span className="text-slate-600 font-medium text-sm">
 Top Talukas in <span className="text-teal-600 font-semibold">{selectedDepartment}</span>
 </span>
 </div>
 <ViewModeDropdown />
 </div>
 ...
 <span className="text-slate-600 font-medium text-sm">
 Departments in <span className="text-teal-600 font-semibold">{drillDownTaluka}</span>
 </span>
 </div>
 <ViewModeDropdown />
 </div>
