...
export default function AICategoryTable({
  ...
  return (
    <div className="relative bg-white p-1 rounded-2xl shadow-xl hover:scale-101 transition-transform duration-300 flex flex-col overflow-hidden group h-full">
