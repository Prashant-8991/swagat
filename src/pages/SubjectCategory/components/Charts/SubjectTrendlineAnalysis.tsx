...
export default function SubjectTrendlineAnalysis({
  ...
  return (
    <div className="relative bg-white p-1 rounded-2xl shadow-xl hover:scale-101 transition-transform duration-300 h-full flex flex-col overflow-hidden group">
