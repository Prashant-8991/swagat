...
const COLORS = {
    district: { light: CHART_COLORS.primary, dark: PASTEL_COLORS.slate },
    department: { light: CHART_COLORS.accent, dark: PASTEL_COLORS.slate },
    taluka: { light: CHART_COLORS.secondary, dark: PASTEL_COLORS.mint },
    designation: { light: PASTEL_COLORS.peach, dark: PASTEL_COLORS.coral },
    green: PASTEL_COLORS.sage,
    yellow: PASTEL_COLORS.amber,
    red: PASTEL_COLORS.coral
};
...
function KPICard({ title, value }: { title: string; value: number }) {
    return (
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl transition-transform duration-300 p-6 shadow-sm">
...
function SortButton({ label, field, currentField, direction, onClick }: {
    ...
    return (
        <button
            ...
            className="flex items-center gap-1 hover:text-teal-600 transition-colors group"
        >
            {label}
 ...
 `;
        ...
        radar: {
            ...
            splitArea: {
                show: true,
                areaStyle: {
                    color: ['rgba(126, 174, 196, 0.05)', 'rgba(126, 174, 196, 0.1)']
                }
            },
            axisLine: {
                lineStyle: {
        ...
        <div>
            <div className="mb-4 flex items-center gap-2">
                ...
                <select
                    ...
                    className="px-3 py-1.5 text-sm bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent text-gray-900"
                >
        ...
        <div className="space-y-4">
            <div className="flex justify-end">
                <select
                    ...
                    className="px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all"
                >
        ...
        series: [
            {
                ...
                data: data.map(item => ({
                    ...
                    itemStyle: {
                        color: item.grievanceReviewType === selectedValue ? '#7EAEC4' : undefined,
    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center p-6">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-red-500 p-8 max-w-lg">
