...
export default function PositiveDisposeComponent() {
 ...
 {hasActiveFilters && (
 <div className="mt-4 p-4 bg-white/80 backdrop-blur-sm dark:bg-gray-900/50 rounded-lg border border-gray-200/40 dark:border-gray-700">
 <div>
 ...
 <div className="relative bg-[#b8e0d2]/30 dark:bg-[#b8e0d2]/10 transition-transform duration-300 border border-gray-200/60 dark:border-[#b8e0d2]/50 rounded-2xl p-5 shadow-sm">
 ...
 <div className="relative bg-[#adf7b6]/30 dark:bg-[#adf7b6]/10 transition-transform duration-300 border border-gray-200/60 dark:border-[#adf7b6]/50 rounded-2xl p-5 shadow-sm">
 <div className="text-sm font-semibold text-black dark:text-white mb-2">
 Avg Disposal Days
 </div>
 <div className="text-4xl font-bold text-black dark:text-white mb-1">
 ...
 <div className="relative bg-white/80 backdrop-blur-sm dark:bg-gray-800/40 border border-gray-200/40 dark:border-gray-700/50 rounded-2xl p-5 shadow-sm">
