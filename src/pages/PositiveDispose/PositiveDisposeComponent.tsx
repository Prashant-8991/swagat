    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      ...
      <div className="max-w-[1800px] mx-auto space-y-6">
        ...
        <div className="mb-4 flex flex-wrap items-center gap-3">
          ...
          {loading && (
            <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-purple-500 ml-auto"></div>
          )}
        ...
        {hasActiveFilters && (
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-black dark:border-gray-700">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative bg-[#b8e0d2]/30 dark:bg-[#b8e0d2]/10 backdrop-blur-xl hover:scale-105 transition-transform duration-300 border border-black dark:border-[#b8e0d2]/50 rounded-2xl p-6 shadow-lg">
          ...
          <div className="relative bg-[#adf7b6]/30 dark:bg-[#adf7b6]/10 backdrop-blur-xl hover:scale-105 transition-transform duration-300 border border-black dark:border-[#adf7b6]/50 rounded-2xl p-6 shadow-lg">
            <div className="text-sm font-semibold text-black dark:text-white mb-2">
              Avg Disposal Days
            </div>
            <div className="text-4xl font-bold text-black dark:text-white mb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-black dark:border-gray-700/50 rounded-2xl p-6 shadow-lg">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    filters.disposedPending === 'Disposed'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    filters.disposedPending === 'Pending'
          ...
          <div className="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-black dark:border-gray-700/50 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <select
                ...
                className="px-3 py-1.5 text-sm bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 dark:text-white"
              >
...
const ContextMenu = React.memo(function ContextMenu({
  ...
  return (
    <div
      ...
      className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden min-w-[220px]"
    >
        ...
        <tbody>
          {data.map((item) => (
            <tr
              ...
              className={`border-b border-gray-100 dark:border-gray-800 cursor-pointer transition-all hover:bg-blue-50 dark:hover:bg-blue-900/20 ${
                selectedLevel === item.levelNo ? 'bg-blue-100 dark:bg-blue-900/30 font-semibold' : ''
              }`}
            >
