    ...
    return (
        <div className="relative">
                        ...
                        <button
                            ...
                            className={`px-2 py-1 rounded text-sm font-medium transition-colors ${
                                idx === breadcrumb.length - 1
                                    ...
                                    : 'text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-purple-600'
                            }`}
                        >
                            {crumb.label}
                        </button>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 max-h-[500px] overflow-y-auto p-1">
                        {treeData.map((dept, idx) => (
                            <button
                                ...
                                disabled={isLoading}
                                className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 hover:bg-purple-50 dark:hover:bg-purple-900/30 border border-gray-200 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-700 rounded-lg transition-all text-left group disabled:opacity-50"
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="font-medium text-gray-900 dark:text-gray-100 truncate text-sm group-hover:text-purple-700 dark:group-hover:text-purple-300">
                                        {dept.data.name}
                                    </div>
            ...
            {!showDepartmentCards && links.length > 0 && (
                <div 
                    className="w-full bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden relative"
                ...
                >
                    {isLoading && (
                        <div className="absolute inset-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm z-10 flex items-center justify-center">
                            <div className="flex items-center gap-3 bg-white dark:bg-gray-700 px-4 py-2 rounded-lg shadow-lg border">
